...
* **Yueyang Liu**, Xu Kuang, and Benjamin Van Roy, [Non-Stationary Bandit Learning via Predictive Sampling](https://arxiv.org/abs/2205.01970), 2022.
  * "Thompson sampling and its variants with sliding window, discounting of past rewards, or perioridc restart, do not work well in non-stationary environments. We propose a principled approach to designing agents that prioritize the acquisition of lasting information."
